...
const HMap cathedral_organ = {
    {130.81,   0.0}, {261.63,  -1.0}, {392.0,   -6.0}, {523.25,  -3.0}, {65.41,  -10.0},  
    {784.0,   -8.0}, {900.0,  -12.0}, {1046.5, -10.0}, {2500.0, -15.0}
};

const HMap angelic_harmonica = { 
    {261.63, -15.0}, {523.25,   0.0}, {1570.0,  -2.0}, {2617.0,  -5.0}, {3664.0, -10.0}, 
    {4700.0, -20.0}, {8000.0, -25.0}, {12000.0, -40.0}
};

const HMap gritty_bass = {
    {32.7,    -6.0}, {100.0,  -18.0}, {65.41,    0.0}, {130.82,  -3.0}, {196.23,  -9.0}, 
    {261.64, -15.0}, {450.0,  -12.0}, {2000.0, -30.0}    
};

const HMap vintage_trumpet = {
    {466.16,   0.0}, {800.0,   -8.0}, {932.32,  -1.5}, {1398.5,  -3.0}, {1500.0, -10.0}, 
    {1864.6,  -6.0}, {2330.8,  -9.0}, {2797.0, -12.0}, {2800.0, -20.0}, {3263.2, -18.0}, 
    {4000.0, -30.0}, {6000.0, -40.0}     
};

const HMap forest_flute = {
    {392.0,    0.0}, {610.0,  -10.0}, {784.0,   -12.0}, {950.0,  -14.0},  {1176.0,  -8.0}, 
    {1568.0, -20.0}, {2000.0, -15.0}, {3000.0, -25.0}, {5000.0, -40.0},   
};

const HMap retro_guitar = {
    {261.63,  0.0}, {273.0,  -22.0}, {522.5,  -4.0}, {650.0,  -16.0}, {783.0,  -8.0},  
    {1045.0, -12.0}, {1306.0, -18.0}, {1200.0, -30.0}, {1567.0, -24.0},   
};
const HMap simple_sine = { 
	{1.0, 0.0} 
};
const HMap simple_saw = {    
	{261.63,  0.0}, {523.25, -6.0}, {784.88, -9.5}, {1046.5, -12.0}, {1308.1, -14.0}
};
...
struct MyModularOscillator : Oscillator {
	...
	MyModularOscillator(HMap in_hs = hsg::simple_sine){
		hs = in_hs.size() > 0 ? in_hs : hsg::simple_sine; // we need at least one harmonic
...
struct MySynth : Synth {
	...
	MySynth() {
        ...
        presets = {
	    	...
	    	{ "Diabolic Base (Harmonica)", { 3, 1, 5.500, 746.410, 829.998, 0, 1.000, 0.462, 0.043, 0.092, 0.882, 0.508, 2, 1.472, 0.220, 1.000, 1.000, 1.000, 1.000 } },
	    	{ "Bad Bass", { 1, 1, 6.735, 1000.000, 2000.000, 0, 1.000, 0.890, 0.072, 0.066, 1.000, 0.559, 2, 10.000, 1.000, 1.000, 1.000, 1.000, 1.000 } },
	    	{ "Vanilla Saw", { 6, 0, 1.000, 10.000, 10.000, 0, 1.000, 0.000, 0.035, 0.068, 1.000, 0.000, 2, 1.000, 0.000, 1.000, 1.000, 1.000, 1.000 } },
	    	{ "Breezy Flute", { 5, 0, 5.500, 500.000, 1000.000, 1, 8.096, 0.188, 0.500, 0.497, 0.836, 0.364, 1, 6.797, 0.213, 1.000, 1.000, 1.000, 1.000 } },
	    	{ "Heavy Guitar", { 2, 0, 5.500, 500.000, 1000.000, 2, 8.096, 0.351, 0.072, 0.066, 1.000, 0.559, 0, 6.797, 0.213, 1.000, 1.000, 1.000, 1.000 } },
	    	{ "Alien Organ", { 0, 0, 6.735, 1000.000, 2000.000, 2, 10.000, 0.890, 0.799, 0.765, 1.000, 0.559, 3, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000 } },
	    };
...
## more harmonic groups / presets / milestones
